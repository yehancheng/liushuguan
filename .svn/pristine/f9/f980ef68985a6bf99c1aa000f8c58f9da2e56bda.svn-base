...
{
	var unit_id     = "2646296";
	var client_ip   = "121.14.24.163";
	var server_time = "1382776947";
	var verify_code = "83e7757f";
	var type        = "0";
...
document.write("<img src=\""+dest+"\" border=\"0\" width=\"1\" height=\"1\" />");
	...
	var icon_link_host="tongji.linezing.com";
        ...
        if(url_id>0)
                document.write('<scr'+'ipt src=\'http://js.tongji.linezing.com/2646296/'+url_id+'/clickcollect.js\'></scr'+'ipt>');
}
